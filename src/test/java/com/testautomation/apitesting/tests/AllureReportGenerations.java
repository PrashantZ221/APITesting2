...
import com.testautomation.apitesting.tests.utils.FileNameConstants;
...
@Epic("Epic-01")
@Feature("Feature-01 Create update delete booking")

public class AllureReportGenerations extends BaseTest {
    //private static final Logger logger = LogManager.getLogger(EndToEndAPITest.class);

    private static final Logger logger = LogManager.getLogger(AllureReportGenerations.class);

    @Story("Story 1")
    @Test(description = "Description - end to end api testing")
